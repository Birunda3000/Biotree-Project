...
from utils import return_components_in_topological_order
...
for subgraph in order:
    for node in subgraph:
        ...
        plt.annotate(df.loc[node, 'nome'], (x1, y1), color='black', fontsize=12, ha='center', va='center')
        ...
        for index, row in df_edges_origin.iterrows():
            ...
            plt.arrow(x1, y1, x2-x1, y2-y1, color='black', linestyle='-', linewidth=1, head_width=0.1, head_length=0.1, length_includes_head=True)
