"""
Django settings for BioTree project.
...
SECRET_KEY = 'django-insecure-4qnn4u%%i_3b90fnu-=8lcaf6_gwq=m#v1mgyd)5vy#3yae8gt'
...
ROOT_URLCONF = 'BioTree.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, ''),BASE_DIR/"templates"],#static!!!
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'BioTree.wsgi.application'
